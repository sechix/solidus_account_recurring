  ...
  module Admin
    class PlansController < Spree::Admin::BaseController
      ...
      def plan_params(action=:create)
          params.require(:plan).permit(:name, :description, :free_shipping, :free_cleaning, :trial_period_days, :interval, :currency, :amount, :active, :interval_count,:points, :special_sales, :default)
      end
